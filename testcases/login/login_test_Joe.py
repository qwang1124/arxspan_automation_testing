...
class LoginTestJoe(unittest.TestCase):
    ...
    @allure.testcase('login test Accent Tx Model')
    def test2(self):
            driver = self.driver
            driver.get(self.base_url)
            driver.maximize_window()
    ...
    @allure.testcase('login test BIM')
    def test3(self):
        driver = self.driver
        driver.get(self.base_url)
        driver.maximize_window()
    ...
    @allure.testcase('login test Relay Test')
    def test8(self):
        driver = self.driver
        driver.get(self.base_url)
        driver.maximize_window()
    ...
    @allure.testcase('login test Sunovion Model - Work Requests')
    def test9(self):
        driver = self.driver
        driver.get(self.base_url)
        driver.maximize_window()
    ...
    @allure.testcase('login test Workflow Pilot - ARV')
    def test10(self):
        driver = self.driver
        driver.get(self.base_url)
        driver.maximize_window()
