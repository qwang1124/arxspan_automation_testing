...
class TestCreateexperimentJoe(unittest.TestCase):
    ...
    def test6(self):
        ...
        driver.find_element_by_xpath('//*[@id="file_90186_tr"]/td[4]/a[3]').click()

        # Make an edit to the file and save it locally and upload again
        driver.find_element_by_xpath('//*[@id="file_90186_tr"]/td[4]/a[2]').click()
        field = driver.find_element_by_id('file1_90186')
